            ...
            <fieldset disabled={isReadOnly} className="border-2 border-cnk-sidebar-dark p-4 font-sans text-sm disabled:bg-slate-50">
                ...
                <div className="flex justify-between items-start border-b-2 border-cnk-sidebar-dark pb-2">
                    ...
                    <div className="text-right">
                        <span>{t('date').toUpperCase()}: </span><input type="date" value={formState.formTarihi} onChange={(e) => handleInputChange(e)} id="formTarihi" className="w-28 border-b border-cnk-txt-muted-light focus:outline-none bg-transparent" readOnly={isReadOnly} />
                        <br/>
